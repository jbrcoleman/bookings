...
import (
	...
	"github.com/jbrcoleman/bookings/internal/config"
	"github.com/jbrcoleman/bookings/internal/forms"
	"github.com/jbrcoleman/bookings/internal/models"
	"github.com/jbrcoleman/bookings/internal/render"
)
...
// Emperors renders the room page
func (m *Repository) Emperors(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "emperor.page.go.tmpl", &models.TemplateData{})
}

// Senators renders the room page
func (m *Repository) Senators(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "senator.page.go.tmpl", &models.TemplateData{})
}
